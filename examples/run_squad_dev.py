...
def main():
    ...
    parser.add_argument("--trained_model", default=None, type=str, required=True,
                        help="Trained Model for dev set loss calculation")
...
#                 cache_dir=PYTORCH_PRETRAINED_BERT_CACHE / 'distributed_{}'.format(args.local_rank))
    ...
    model_state_dict = torch.load(args.trained_model, map_location=lambda storage, loc: storage)
